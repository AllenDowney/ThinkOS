...
%TODO: make this section consistent with Head First C

% Also, fix header.html add padding.
...
{\tt "Hello, World"}, those character will be stored in the
static segment.
...
\item The stack segment contains the run-time stack, which is
  made up of stack frames.  Each time a function is called, a stack
